  ...
  return (
    <div className="justify-center bg-primarygray  gap-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 p-5 ">
      {query.data?.map((product) => (
        <div key={product.id} className=" justify-center grid grid-cols-1 grid-rows-1 gap-y-2  border-white bg-white shadow-sm hover:shadow-lg px-4 py-2 border rounded-lg overflow-hidden max-auto">
          ...
          <button className="bg-uniq hover:bg-primarygray mb-2 hover:border border-black hover:text-black  rounded-md text-white btn p-2"
